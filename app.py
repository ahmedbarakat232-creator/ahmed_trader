...
def load_saved_settings():
    ...
    return {
        ...
        "phone_number": "",
        "notifications_active": True # تم ضبطه ليكون افتراضياً True
    }
...
with st.expander("⚙️ إعدادات المحفظة والاتصال والإشعارات"):
    ...
    notif_active = st.checkbox("🔔 تشغيل الإشعارات الفورية عند الإشارات القوية", value=settings.get("notifications_active", True)) # تم ضبطه ليكون افتراضياً True
    ...
    use_gen_ai = st.checkbox("🔥 تفعيل مستشار الأخبار الذكي التلقائي", value=True) # تم ضبطه ليكون افتراضياً True
